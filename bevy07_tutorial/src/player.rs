...
use crate::{BASE_SPEED, GameTextures, PLAYER_LASER_SIZE, PLAYER_RESPAWN_DELAY, PLAYER_SIZE, PlayerState, SPRITE_SCALE, TIME_STEP, WinSize};
...
fn player_fire_system(
    ...
    if let Ok(player_transform) = query.get_single() {
        if keyboard.just_pressed(KeyCode::Space) {
            let (x, y) = (player_transform.translation.x, player_transform.translation.y);
